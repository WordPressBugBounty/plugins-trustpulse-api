...
define( 'TRUSTPULSE_WC_PAGE_NAME', 'tp-wc-verification' );
define( 'TRUSTPULSE_ABOUT_PAGE_NAME', 'tp-about-us' );
...
class TPAPI {
	...
	/**
	 * The rest API object for processing requests.
	 *
	 * @since 1.2.3
	 *
	 * @var TPAPI_RestApi(
	...
	/**
	 * Loads REST API class into scope.
	 *
	 * @since 1.2.3
	 */
	public function load_rest() {
		...
		$this->rest_api = new TPAPI_RestApi();
	}
